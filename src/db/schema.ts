...
export const kanjiTranslation = sqliteTable("kanji_translation", {
...
export const wordTranslations = sqliteTable("word_translation", {
  id: integer().primaryKey({ autoIncrement: true }),
  writing: text().notNull().references(() => words.mainWriting),
  language: text().notNull(),
...
export const radicalKeyword = sqliteTable("radical_keyword", {
  id: integer().primaryKey({ autoIncrement: true }),
  radical: text().notNull().references(() => radicals.radical),
  language: text().notNull(),
